...
export function socketController(socket: Socket) {
    ...
    socket.on('disconnect', async () => {
        try {
            ...
            console.log("error while user disconnecting:", e)
        }
    });
    ...
    socket.on('join-lobby', async (arg, callback) => {
        try {
            ...
            console.log('error while user joining lobby:', e)
        }
    });
    ...
    socket.on('join-room', async (arg, callback) => {
        try {
            ...
            console.log('error while user joining room:', e)
        }
    });
    ...
    socket.on('start-test', async (arg, callback) => {
        try {
            ...
            console.log('error while starting test:', e)
        }
    });
    ...
    socket.on('stop-test', async (arg, callback) => {
        try {
            ...
            console.log("error in stoping test:", e)
        }
    });
    ...
    socket.on('kick-out', async (arg, callback) => {
        try {
            ...
            console.log('error while kicking out:', e)
        }
    });
    ...
    socket.on('question-submit', async (arg, callback) => {
        try {
            ...
            console.log('error while submit each question:', e)
        }
    });
    ...
    socket.on('send-to-lobby', (arg) => {
        try {
            ...
            console.log('error while user sending to lobby:', e)
        }
    });
    ...
    socket.on('send-all', (arg, callback) => {
        try {
            ...
            console.log('error while user sending to all:', e)
        }
    });
}